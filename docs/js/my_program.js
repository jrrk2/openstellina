...
function findWasmBinary() {
  return locateFile("my_program.wasm");
}
...
function js_fetch_partial_file(url, start, end, buffer_ptr, status_ptr) {
  var xhr = new XMLHttpRequest;
  ...
  try {
    ...
    if (xhr.status === 206) {
      ...
      for (var i = 0; i < response.length; ++i) {
        byteArray[i] = response.charCodeAt(i) & 255;
      }
      HEAPU8.set(byteArray, buffer_ptr >>> 0);
...
var _pack_chars_to_float = Module["_pack_chars_to_float"] = createExportWrapper("pack_chars_to_float", 1);

var _unpack_float_to_chars = Module["_unpack_float_to_chars"] = createExportWrapper("unpack_float_to_chars", 2);

var _myFunction = Module["_myFunction"] = createExportWrapper("myFunction", 1);

var _myFloat = Module["_myFloat"] = createExportWrapper("myFloat", 7);

var _float_to_string_sub = Module["_float_to_string_sub"] = createExportWrapper("float_to_string_sub", 2);

var _float_to_string = Module["_float_to_string"] = createExportWrapper("float_to_string", 1);

var _myAscii = Module["_myAscii"] = createExportWrapper("myAscii", 2);
