...
|           ("state", `String "IDLE")]) -> ()
          ...
          [("system",
            `Assoc [("size", `Int sys_size) -> () |("available", `Int sys_avail)]) -> ()
|           ("data",
            `Assoc [("size", `Int data_size) -> () |("available", `Int data_avail)]) -> ()
|           ("usb",
            `Assoc
              [("size", `Int usb_size) -> () |("available", `Int usb_avail) -> ()
|               ("changeCount", `Int changes)])]) -> ()

          [("temperature", `Int temp) -> () |("temperatureDelta", `Int temp_delta) -> ()
|           ("humidity", `Float humidity) -> ()
|           ("humidityDelta", `Float humid_delta) -> ()
|           ("defogStatus", `String defog) -> ()
|           ("dewpointDepression", `Float dewpoint_depress)]) -> ()

          [
|           ("ALT",
            `Assoc
              [("position", `Float alt_pos) -> () |("state", `String alt_state) -> ()
|               ("atStop", `Bool alt_stopped) -> () |("calibrated", `Bool alt_calib)]) -> ()
|           ("DER",
            `Assoc
              [("position", `Int derot_pos) -> () |("state", `String derot_state) -> ()
|               ("atStop", `Bool derot_stopped) -> () |("calibrated", `Bool derot_calib)]) -> ()
|           ("MAP",
            `Assoc
              [("position", `Int map_pos) -> () |("state", `String map_state) -> ()
|               ("calibrated", `Bool map_calib)])]) -> ()

          [("open",
            `Assoc
              [("id", `String "open-1-365-5df04c") -> ()
|               ("ctx", `String "/general/openForMaintenance#365-2") -> ()
|               ("type", `String "OPEN") -> () |("startTime", `Int 1646488898545) -> ()
|               ("endTime", `Int 1646488925045) -> () |("stopped", `Bool true) -> ()
|               ("error", `Null)]) -> ()
|           ("park",
            `Assoc
              [("id", `String "park-4-365-5df04c") -> ()
|               ("ctx", `String "/general/park#365-3") -> ()
|               ("type", `String "PARK") -> () |("startTime", `Int 1646489035959) -> ()
|               ("endTime", `Int 1646489063167) -> () |("stopped", `Bool true) -> ()
|               ("error", `Null)]) -> ()
|           ("autoInit", `Null) -> ()
|           ("observation", `Assoc obs_lst) -> ()
|           ("sunMode", `Null) -> ()
|           ("plan", `Assoc plan_lst) -> ()
